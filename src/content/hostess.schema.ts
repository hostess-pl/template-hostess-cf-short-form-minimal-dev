...
export const hostessSchema = z.object({
  ...
  branding: z.object({
    ...
    customBackgroundColor: z.string().regex(/^#[0-9A-Fa-f]{6}$/).or(z.literal('')).default(''),
    headingColor: z.string().regex(/^#[0-9A-Fa-f]{6}$/).or(z.literal('')).default(''),
    bodyColor: z.string().regex(/^#[0-9A-Fa-f]{6}$/).or(z.literal('')).default(''),
    mutedColor: z.string().regex(/^#[0-9A-Fa-f]{6}$/).or(z.literal('')).default(''),
