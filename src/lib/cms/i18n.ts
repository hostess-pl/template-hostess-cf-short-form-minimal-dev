...
export type CmsChromeStrings = {
  ...
  fieldTitle: string
  fieldPortfolioRole: string
  fieldEmploymentTitle: string
  fieldCompany: string
  fieldDescription: string
  fieldPortfolioDescription: string
  fieldEmploymentDescription: string
  fieldDate: string
  fieldBrand: string
  fieldPhoto: string
  ...
  phEventTypes: string
  phTitle: string
  phPortfolioRole: string
  phEmploymentTitle: string
  phCompany: string
  phDescription: string
  phPortfolioDescription: string
  phEmploymentDescription: string
  phDate: string
  phBrand: string
...
const PL: CmsChromeStrings = {
  ...
  addPortfolioItem: 'Dodaj kolejną realizację',
  ...
  subsectionAboutCopy: 'Jaka jesteś w pracy?',
  ...
  subsectionEmployment: 'Doświadczenie spoza branży hostess',
  ...
  fieldName: 'Nazwa',
  fieldLevel: 'Poziom',
  fieldTraits: 'Twoje mocne strony',
  fieldSkills: 'Dodatkowe umiejętności',
  ...
  fieldTitle: 'Tytuł',
  fieldPortfolioRole: 'Twoja rola',
  fieldEmploymentTitle: 'Stanowisko',
  fieldCompany: 'Firma',
  fieldDescription: 'Opis',
  fieldPortfolioDescription: 'Co robiłaś?',
  fieldEmploymentDescription: 'CZYM SIĘ ZAJMOWAŁAŚ?',
  fieldDate: 'Data',
  fieldBrand: 'Marka lub wydarzenie',
  fieldPhoto: 'Zdjęcie',
  fieldHeroPhoto: 'Zdjęcie główne (hero)',
  fieldExtraPhotos: 'Dodaj dodatkowe zdjęcia (opcjonalnie)',
  fieldAddExtraPhoto: 'Dodaj zdjęcie do wydarzenia',
  fieldVideoOptional: 'Film (opcjonalnie)',
  fieldDisplayName: 'Imię wyświetlane na stronie',
  fieldLegalName: 'Imię i nazwisko',
  fieldEmail: 'E-mail',
  fieldPhone: 'Telefon',
  fieldLocation: 'Miasto zamieszkania',
  fieldProfessionalStatus: 'Obecny status',
  fieldWorkCities: 'Gdzie możesz pracować?',
  socialsHeading: 'Social media (opcjonalnie)',
  contactHint:
    'Te informacje zostaną wyświetlone w sekcji kontaktowej Twojego portfolio. Jeśli chcesz je zmienić, możesz zrobić to tutaj.',
  ...
  phProfileHero:
    'np. Od 3 lat pracuję jako hostessa podczas eventów, targów i konferencji. Mam doświadczenie w obsłudze stref VIP oraz akcjach promocyjnych. Jestem komunikatywna, otwarta i dobrze odnajduję się w pracy z ludźmi.',
  phBioShort: 'Jedno–dwa zdania bio na stronie',
  phAboutLead: 'Napisz 1–2 zdania o tym, jaka jesteś w pracy i co wyróżnia Cię jako hostessę.',
  phMainText:
    'Napisz, za co cenisz się w pracy — możesz wspomnieć o swoich mocnych stronach, kontakcie z gośćmi, odpowiedzialności lub reprezentowaniu marki.',
  ...
  phField: 'np. Marketing',
  phUniversity: 'np. Uniwersytet Warszawski',
  phStart: 'MM-RRRR',
  phEnd: 'MM-RRRR lub puste jeśli trwa',
  phName: 'np. angielski',
  phLevel: 'np. B2 / native',
  phTraits: 'np. komunikatywność, punktualność, odpowiedzialność',
  phSkills: 'np. obsługa eventów, tłumaczenia, social media, sprzedaż',
  phHeight: 'np. 175 cm',
  phDressSize: 'np. 36 / S',
  ...
  phPortfolioRole: 'Hostessa VIP, Hostessa targowa...',
  phEmploymentTitle: 'np. Kelnerka, Sprzedawca, Recepcjonistka',
  phCompany: 'np. Hotel Marriott, Zara, Restauracja XYZ',
  phDescription: 'Co robiłaś na tym stanowisku / wydarzeniu',
  phPortfolioDescription:
    'np. Obsługiwałam strefę VIP, witałam gości i udzielałam informacji uczestnikom.',
  phEmploymentDescription:
    'np. Obsługiwałam klientów, przyjmowałam zamówienia i dbałam o sprawny przebieg obsługi.',
  phDate: 'MM-RRRR',
  phBrand: 'Samsung, Polsat Hit Festival...',
...
const EN: CmsChromeStrings = {
  ...
  addItem: 'Add item',
  addPortfolioItem: 'Add another project',
  addPhoto: 'Add photo',
  remove: 'Remove',
  reorderUp: 'Move up',
  ...
  subsectionAboutCopy: 'What are you like at work?',
  ...
  subsectionEmployment: 'Experience outside hostessing',
  ...
  fieldHeadline: 'Short headline',
  fieldGreeting: 'Greeting',
  fieldProfileHero: 'Write a few sentences about yourself',
  fieldBioShort: 'Bio (short)',
  fieldAboutLead: 'Text 1',
  fieldMainText: 'Text 2',
  fieldGalleryLabel: 'Gallery label / nav',
  fieldGalleryTitle: 'Gallery title',
  fieldAboutLabel: 'About label / nav',
  fieldAboutTitle: 'Section title',
  ...
  fieldName: 'Name',
  fieldLevel: 'Level',
  fieldTraits: 'Your strengths',
  fieldSkills: 'Additional skills',
  ...
  fieldTitle: 'Title',
  fieldPortfolioRole: 'Your role',
  fieldEmploymentTitle: 'Position',
  fieldCompany: 'Company',
  fieldDescription: 'Description',
  fieldPortfolioDescription: 'What did you do?',
  fieldEmploymentDescription: 'WHAT DID YOU DO?',
  fieldDate: 'Date',
  fieldBrand: 'Brand or event',
  fieldPhoto: 'Photo',
  fieldHeroPhoto: 'Hero photo',
  fieldExtraPhotos: 'Add extra photos (optional)',
  fieldAddExtraPhoto: 'Add photo to event',
  fieldVideoOptional: 'Video (optional)',
  fieldDisplayName: 'Name displayed on the site',
  fieldLegalName: 'Legal name',
  fieldEmail: 'Email',
  fieldPhone: 'Phone',
  fieldLocation: 'City of residence',
  fieldProfessionalStatus: 'Current status',
  fieldWorkCities: 'Where can you work?',
  socialsHeading: 'Social media (optional)',
  contactHint:
    'This information will appear in the contact section of your portfolio. If you want to change it, you can do so here.',
  mediaUrlPlaceholder: 'filename.jpg or URL',
  phHeadline: 'e.g. A first impression that builds trust',
  phGreeting: "e.g. Hi, I'm Anna!",
  phProfileHero:
    'e.g. I have worked as a hostess at events, trade fairs, and conferences for three years. I have experience supporting VIP areas and promotional campaigns. I am communicative, open, and enjoy working with people.',
  phBioShort: 'One–two sentence bio for the site',
  phAboutLead: 'Write 1–2 sentences about what you are like at work and what sets you apart as a hostess.',
  phMainText:
    'Write what you value about yourself at work. You can mention your strengths, guest communication, reliability, or representing a brand.',
  phGalleryLabel: 'Portfolio',
  ...
  phField: 'e.g. Marketing',
  phUniversity: 'e.g. University of Warsaw',
  phStart: 'MM-YYYY',
  phEnd: 'MM-YYYY or leave empty if ongoing',
  phName: 'e.g. English',
  phLevel: 'e.g. B2 / native',
  phTraits: 'e.g. communication, punctuality, responsibility',
  phSkills: 'e.g. event support, interpreting, social media, sales',
  phHeight: 'e.g. 175 cm',
  ...
  phPortfolioRole: 'VIP hostess, trade fair hostess…',
  phEmploymentTitle: 'e.g. Waitress, Sales assistant, Receptionist',
  phCompany: 'e.g. Marriott Hotel, Zara, XYZ Restaurant',
  phDescription: 'What you did in this role / event',
  phPortfolioDescription:
    'e.g. I supported the VIP area, welcomed guests, and provided information to attendees.',
  phEmploymentDescription:
    'e.g. I served customers, took orders, and helped ensure smooth service.',
  phDate: 'MM-YYYY',
  phBrand: 'Samsung, Polsat Hit Festival…',
